...
void TMC5130StepperBase<T>::TMC_OUTPUT(bool input) {
  ...
  SELF.write(OUTPUT_register.address, OUTPUT_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: X_COMPARE
template<typename T>
...
void TMC5130StepperBase<T>::X_COMPARE(uint32_t input) {
  ...
  SELF.write(X_COMPARE_register.address, X_COMPARE_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// RW: RAMPMODE
template<typename T>
...
void TMC5130StepperBase<T>::RAMPMODE(uint8_t input) {
  ...
  SELF.write(this->THIGH_register.address, this->THIGH_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// RW: XACTUAL
template<typename T>
...
void TMC5130StepperBase<T>::XACTUAL(int32_t input) {
  SELF.write(XACTUAL_register.address, input);
}
///////////////////////////////////////////////////////////////////////////////////////
// R: VACTUAL
template<typename T>
...
void TMC5130StepperBase<T>::VSTART(uint32_t input) {
  ...
  SELF.write(VSTART_register.address, VSTART_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: A1
template<typename T>
...
void TMC5130StepperBase<T>::A1(uint16_t input) {
  ...
  SELF.write(A1_register.address, A1_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: V1
template<typename T>
...
void TMC5130StepperBase<T>::V1(uint32_t input) {
  ...
  SELF.write(V1_register.address, V1_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: AMAX
template<typename T>
...
void TMC5130StepperBase<T>::AMAX(uint16_t input) {
  ...
  SELF.write(AMAX_register.address, AMAX_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: VMAX
template<typename T>
...
void TMC5130StepperBase<T>::VMAX(uint32_t input) {
  ...
  SELF.write(VMAX_register.address, VMAX_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: DMAX
template<typename T>
...
void TMC5130StepperBase<T>::DMAX(uint16_t input) {
  ...
  SELF.write(DMAX_register.address, DMAX_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: D1
template<typename T>
...
void TMC5130StepperBase<T>::D1(uint16_t input) {
  ...
  SELF.write(D1_register.address, D1_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: VSTOP
template<typename T>
...
void TMC5130StepperBase<T>::VSTOP(uint32_t input) {
  ...
  SELF.write(VSTOP_register.address, VSTOP_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// W: TZEROWAIT
template<typename T>
...
void TMC5130StepperBase<T>::TZEROWAIT(uint16_t input) {
  ...
  SELF.write(TZEROWAIT_register.address, TZEROWAIT_register.sr);
}
///////////////////////////////////////////////////////////////////////////////////////
// RW: XTARGET
template<typename T>
...
void TMC5130StepperBase<T>::XTARGET(int32_t input) {
  SELF.write(XTARGET_register.address, input);
}
