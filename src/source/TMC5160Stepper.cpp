 ...
 * TMC5160Stepper.cpp
 * Implementing methods for TMC5160 (TMC5161)
 */
...
uint8_t TMC5160Stepper::pwm_ofs_auto()  { PWM_AUTO_t r{}; r.sr = PWM_AUTO(); return r.pwm_ofs_auto; }
uint8_t TMC5160Stepper::pwm_grad_auto() { PWM_AUTO_t r{}; r.sr = PWM_AUTO(); return r.pwm_grad_auto; }
